...
This interfaces repository keeps Microsoft TypeSpec and JSON Schema beside the
Rust model. The product ORM core owns forward-only migrations, while this interface contract remains wire-compatible.
